...
from uniq.analyzer.expectation import calculate_expectation
...
def state_tomography(
    ...
    Example:
        >>> from uniq.circuit_builder import Circuit
        >>> from uniq.algorithmics.measurement import state_tomography
        >>> c = Circuit()
        >>> c.h(0)           # |0⟩ → (|0⟩+|1⟩)/√2
...
def tomography_summary(
    ...
    Example:
        >>> from uniq.circuit_builder import Circuit
        >>> from uniq.algorithmics.measurement import (
