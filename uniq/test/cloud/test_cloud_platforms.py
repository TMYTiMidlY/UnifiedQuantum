...
Usage:
    pytest uniq/test/test_cloud_platforms.py -v
...
class TestConfigLoading:
    ...
    def test_load_existing_config(self, tmp_path: Path) -> None:
        ...
        from uniq.config import load_config, save_config
    ...
    def test_load_config_different_profiles(self, tmp_path: Path) -> None:
        ...
        from uniq.config import load_config, save_config, get_platform_config
    ...
    def test_validate_config_valid(self) -> None:
        ...
        from uniq.config import validate_config
...
class TestBackendFactory:
    ...
    def test_get_backend_originq(self) -> None:
        ...
        from uniq.backend import get_backend, OriginQBackend
        
        with patch("uniq.backend.OriginQBackend._create_adapter") as mock_create:
    ...
    def test_get_backend_quafu(self) -> None:
        ...
        from uniq.backend import get_backend, QuafuBackend
        
        with patch("uniq.backend.QuafuBackend._create_adapter") as mock_create:
            mock_adapter = MagicMock()
            mock_create.return_value = mock_adapter
    ...
    def test_get_backend_ibm(self) -> None:
        ...
        from uniq.backend import get_backend, IBMBackend
        
        with patch("uniq.backend.IBMBackend._create_adapter") as mock_create:
            mock_adapter = MagicMock()
            mock_create.return_value = mock_adapter
    ...
    def test_get_backend_unknown_raises(self) -> None:
        ...
        from uniq.backend import get_backend
    ...
    def test_list_backends(self) -> None:
        ...
        from uniq.backend import list_backends, BACKENDS
...
class TestCircuitAdapters:
    ...
    def test_originq_adapter_supported_gates(self) -> None:
        ...
        from uniq.circuit_adapter import OriginQCircuitAdapter
    ...
    def test_quafu_adapter_supported_gates(self) -> None:
        ...
        from uniq.circuit_adapter import QuafuCircuitAdapter
    ...
    def test_ibm_adapter_supported_gates(self) -> None:
        ...
        from uniq.circuit_adapter import IBMCircuitAdapter
...
class TestMockSubmitTask:
    ...
    def test_originq_submit_task_mock(self) -> None:
        ...
        from uniq.task.adapters import OriginQAdapter

        with patch("uniq.task.adapters.originq_adapter.load_originq_config") as mock_config:
    ...
    def test_quafu_submit_task_mock(self) -> None:
        ...
        from uniq.task.adapters import QuafuAdapter
        
        with patch("uniq.task.adapters.quafu_adapter.load_quafu_config") as mock_config:
...
class TestMockQueryTask:
    ...
    def test_originq_query_task_success_mock(self) -> None:
        ...
        from uniq.task.adapters import OriginQAdapter, TASK_STATUS_SUCCESS
    ...
    def test_originq_query_task_running_mock(self) -> None:
        ...
        from uniq.task.adapters import OriginQAdapter, TASK_STATUS_RUNNING
...
class TestIBMIntegration:
    ...
    def test_ibm_translate_circuit(self) -> None:
        ...
        from uniq.task.adapters import QiskitAdapter
...
class TestEndToEndWorkflow:
    ...
    def test_e2e_originq_mock(self) -> None:
        ...
        from uniq.circuit_builder import Circuit
        from uniq.circuit_adapter import OriginQCircuitAdapter
        from uniq.backend import OriginQBackend
    ...
    def test_e2e_quafu_mock(self) -> None:
        ...
        from uniq.circuit_builder import Circuit
        from uniq.backend import QuafuBackend
    ...
    def test_e2e_ibm_mock(self) -> None:
        ...
        from uniq.circuit_builder import Circuit
        from uniq.backend import IBMBackend
    ...
    def test_complete_workflow_all_platforms_mock(self) -> None:
        ...
        from uniq.circuit_builder import Circuit
        from uniq.backend import get_backend, BACKENDS
...
class TestCompatibilityWithExistingTests:
    ...
    def test_circuit_adapter_imports(self) -> None:
        ...
        from uniq import circuit_adapter
    ...
    def test_task_adapters_imports(self) -> None:
        ...
        from uniq.task.adapters import (
            QuantumAdapter,
            OriginQAdapter,
            QuafuAdapter,
            QiskitAdapter,
...
class TestCacheManagement:
    ...
    def test_save_and_load_cache(self, tmp_path: Path) -> None:
        ...
        from uniq.backend import OriginQBackend, _get_cache_file_path
