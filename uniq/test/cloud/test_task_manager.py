"""Tests for uniq.task_manager module.
...
class TestQueryTask:
    ...
    def test_query_task_not_found_no_backend(self, temp_cache_dir: Path):
        ...
        with patch("uniq.task_manager.get_task") as mock_get_task:
...
class TestWaitForResult:
    ...
    @patch("uniq.task_manager.query_task")
    def test_wait_for_result_success(self, mock_query, temp_cache_dir: Path):
        ...
        with patch("uniq.task_manager.DEFAULT_CACHE_DIR", temp_cache_dir):
