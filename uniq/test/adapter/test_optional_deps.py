...
Run with: pytest uniq/test/test_optional_deps.py --ignore-glob='uniq/test/__init__.py' -v
"""
...
# Mock uniq_cpp before importing any uniq modules
if 'uniq_cpp' not in sys.modules:
    mock_cpp = MagicMock()
...
from uniq.task.optional_deps import (
...
class TestMissingDependencyError:
    ...
    def test_error_message_format(self):
        ...
        assert "pip install uniq[quafu]" in str(error)
