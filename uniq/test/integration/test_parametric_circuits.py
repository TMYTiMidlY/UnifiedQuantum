...
import math
from uniq.circuit_builder import Circuit, QReg, Qubit
from uniq.circuit_builder.parameter import Parameter, Parameters
from uniq.circuit_builder.named_circuit import circuit_def, NamedCircuit
...
def test_def_roundtrip():
    ...
    # Parse DEF header
    from uniq.originir.originir_line_parser import OriginIR_LineParser
