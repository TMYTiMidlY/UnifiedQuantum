...
def run_test_transpile_qasm():
    ...
    pytest.importorskip("qiskit")
    from uniq.transpiler.qiskit_transpiler import transpile_qasm
    from uniq.transpiler._utils import CompilationFailedException
...
def run_test_transpile_originir():
    ...
    pytest.importorskip("qiskit")
    from uniq.transpiler.qiskit_transpiler import transpile_originir
