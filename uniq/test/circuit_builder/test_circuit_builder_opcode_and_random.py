...
Comprehensive unit tests for:
  - uniq/circuit_builder/opcode.py
  - uniq/circuit_builder/translate_qasm2_oir.py
  - uniq/circuit_builder/random_qasm.py
  - uniq/circuit_builder/random_originir.py
"""

import pytest
from uniq.circuit_builder.opcode import (
...
from uniq.circuit_builder.translate_qasm2_oir import (
    OriginIR_QASM2_dict,
    QASM2_OriginIR_dict,
...
from uniq.circuit_builder.random_qasm import (
    build_qasm_gate,
...
from uniq.circuit_builder.random_originir import (
    build_originir_gate,
...
class TestOpcodeToLineOriginirEdgeCases:
    ...
    def test_empty_operation_raises_runtimeerror(self):
        ...
        from uniq.circuit_builder.opcode import opcode_to_line_originir
...
class TestOpcodeToLineQasmEdgeCases:
    ...
    def test_cbit_raises_notimplementederror(self):
        ...
        from uniq.circuit_builder.opcode import opcode_to_line_qasm
...
class TestTranslateQasm2OirErrorPaths:
    ...
    def test_unsupported_operation_raises_notimplementederror(self):
        ...
        from uniq.circuit_builder.translate_qasm2_oir import get_QASM2_from_opcode
    ...
    def test_direct_mapping_returns_none_for_unmapped(self):
        ...
        from uniq.circuit_builder.translate_qasm2_oir import direct_mapping_qasm2_to_oir
