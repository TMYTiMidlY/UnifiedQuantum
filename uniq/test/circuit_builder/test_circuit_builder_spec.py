...
Covers:
  - uniq/circuit_builder/qasm_spec.py
  - uniq/circuit_builder/originir_spec.py

Tests are pure data-structure assertions; no simulator is needed.
"""

import pytest
from uniq.circuit_builder.qasm_spec import (
...
from uniq.circuit_builder.originir_spec import (
