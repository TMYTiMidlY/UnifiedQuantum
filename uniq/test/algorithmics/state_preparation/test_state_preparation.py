...
class TestBasisState:
    ...
    def run_test_zero_state(self):
        from uniq.algorithmics.state_preparation import basis_state
        c = Circuit()
...
class TestRotationPrepare:
    ...
    def run_test_zero_state(self):
        from uniq.algorithmics.state_preparation import rotation_prepare
        c = Circuit()
...
class TestThermalState:
    ...
    def run_test_zero_beta(self):
        from uniq.algorithmics.state_preparation import thermal_state
        c = Circuit()
...
class TestDickeState:
    ...
    def run_test_k0(self):
        from uniq.algorithmics.state_preparation import dicke_state
        c = Circuit()
        _ensure_n_qubits(c, 3)
        c2 = Circuit()
        _ensure_n_qubits(c2, 3)
