...
from uniq.originir.originir_base_parser import OriginIR_BaseParser
from uniq.circuit_builder.translate_qasm2_oir import get_opcode_from_QASM2
...
class OpenQASM2_BaseParser:
    ...
    def to_circuit(self) -> Circuit:
        """
        The function coverts OpenQASM string into uniq.Circuit object.
