...
from uniq.task.config import load_ibm_config
from uniq.task.optional_deps import MissingDependencyError, check_qiskit
...
class QiskitAdapter(QuantumAdapter):
    ...
    def translate_circuit(self, originir: str) -> "qiskit.QuantumCircuit":
        ...
        ``uniq.circuit_builder.qcircuit`` (which exposes QASM export
