...
Configuration file location: ~/.uniq/uniq.yml
...
CONFIG_DIR = Path.home() / ".uniq"
CONFIG_FILE = CONFIG_DIR / "uniq.yml"
...
def get_active_profile(config_path: str | Path | None = None) -> str:
    ...
    First checks UNIQ_PROFILE environment variable,
    ...
    Returns:
        Active profile name.
    """
    env_profile = os.environ.get("UNIQ_PROFILE")
    if env_profile:
        return env_profile
