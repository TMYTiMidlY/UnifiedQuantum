...
Usage:
    from uniq.task_manager import submit_task, query_task, wait_for_result
    ...
    # Submit task (use UNIQ_DUMMY=true for local simulation)
...
if TYPE_CHECKING:
    from uniq.circuit_builder.qcircuit import Circuit
...
def submit_task(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        dummy: Override dummy mode. If None, uses UNIQ_DUMMY env var.
    ...
    use_dummy = dummy if dummy is not None else UNIQ_DUMMY
