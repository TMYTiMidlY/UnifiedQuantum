...
class IBMBackend(QuantumBackend):
    ...
    def _load_ibm_config(self) -> None:
        ...
        3. uniq.yml configuration file
        """
        from uniq.config import get_ibm_config
        from uniq.network_utils import (
            detect_system_proxy,
    ...
    def check_proxy(self) -> bool:
        ...
        """
        from uniq.network_utils import check_proxy_connectivity
    ...
    def test_connectivity(self) -> dict[str, Any]:
        ...
        """
        from uniq.network_utils import test_ibm_connectivity
